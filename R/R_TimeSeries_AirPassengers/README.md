...
NOTE: this project is the same as the one posted in the Python folder but translated into R language

## 📁 Project Structure

R_TimeSeries_AirPassengers/ ├── AirPassengers.csv ├── TimeSeries_ARIMA_AirPassengers.R └── README.md
...
This project uses an **ARIMA(2,1,1)** Seasonal (0, 1, 0)[12] model to analyze and forecast flight traffic. ARIMA is a classical time series model capable of handling trends and autocorrelations.
...
2. Run the script:
`TimeSeries_ARIMA_AirPassengers.R`

3. Output includes:
- ARIMA model summary
- Forecasted flight numbers for 1961
- Evaluation metrics (MAE, RMSE, BIC, AIC and others)
